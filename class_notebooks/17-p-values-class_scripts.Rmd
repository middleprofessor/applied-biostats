...
```{r inference-vole, message=FALSE, warning=FALSE}
...
# these are for writing up the report
...
```{r null-distribution-t, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Null distribution of t-values. The simulation generated 10,000 t-tests with a true null."}
set.seed(1)
