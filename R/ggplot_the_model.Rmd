...
```{r twoway-fmt_p_value_2, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r ggcheck_the_qq, warning = FALSE}
...
```{r vertical-brackets-functions, echo=FALSE}
