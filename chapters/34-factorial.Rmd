...
6. In an experiment with a single factor with four levels, all six pairwise comparisons may be of interest. In a factorial experiment, it is the simple effects (fewer than all pairwise contrasts) and the interaction effects that are interesting.
...
gg_synergy
```
## Violations in inference
### Heterogeneity

```{r}
exp1a_m1 <- lm(aba ~ hac * indole, data = exp1)
exp1a_m2 <- gls(aba ~ hac * indole,
                data = exp1,
                weights = varIdent(form = ~ 1 | treatment))
tidy(exp1a_m1)

exp1a_m2_emm <- emmeans(exp1a_m2, specs = c("hac", "indole"))
exp1a_m2_ixn <- contrast(exp1a_m2_emm,
