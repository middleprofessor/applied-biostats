...
## Two specifications of a linear model I: the "random error" specification
...
## Two specifications of a linear model II: the "random draw" specification
...
1. **choose a model**. Statistical modeling includes a diverse array of models, yet almost all methods used by researchers in biology, and all models in this book, are generalizations of the linear model specified in \@ref(eq:).
