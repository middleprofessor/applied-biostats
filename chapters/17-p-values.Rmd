...
Let's use the vole data to introduce the *p*-value. The archived format of these data requires some wrangling -- a method for this is in [Vole data].
...
The difference between the mean of the vitamin_E treatment and the control treatment is `r round(b["treatmentvitamin_E"], 1)`. A two-sample *t*-test of this difference is `r t.test(x=vole[treatment=='vitamin_E', lifespan], y=vole[treatment=='control', lifespan], var.equal=TRUE)$p.value`
