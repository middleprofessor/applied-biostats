...
Here I compare pre-insulin infusion blood levels of free fatty acids (ffa) ($ffa_t_210_min_m_m$) between obese and lean subjects at 12h. The data are in Table 2. The assigment of lean or obese is in Table 1, which needs to be merged with Table 2 in order to subset the lean subjects.
