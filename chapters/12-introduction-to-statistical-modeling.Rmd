...
## Three specifications of a linear model
...
### The ANOVA specification of a linear model
...
### Fitting linear models to experimental data in which the $X$ variable is categorical
