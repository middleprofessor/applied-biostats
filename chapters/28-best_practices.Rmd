...
```{r, echo=FALSE, fig.cap="Distribution of the 5000 resampled estimates of the difference in means between the sox10 and wt treatment levels. The dashed lines are located at the 2.5th and 97.5th percentiles of the distribution."}
gghistogram(x = "b1", 
            bins = 30,
            rug = FALSE,
            palette = "npg",
...
```{r}
lmBoot <- function(lm.object, R, rows=FALSE){
  m.residuals <- residuals(lm.object)
