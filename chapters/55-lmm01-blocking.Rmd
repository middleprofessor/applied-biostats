...
perc.m1 <- 1 - coef(summary(m3))["TreatmentTr","Std. Error"]/
  coef(summary(m1))["TreatmentTr","Std. Error"]
perc.m2 <- 1 - coef(summary(m3))["TreatmentTr","Std. Error"]/
  coef(summary(m2))["TreatmentTr","Std. Error"]
```

Note that the estimates of treatment effect do not differ among models. What does differ is the estimated standard error of the treatment effect, which is 24.3 % smaller in the linear mixed model relative to that in the linear model, and 50.1 % smaller in the linear mixed model relative to that in the linear model fit to the block means. This difference in SE propogates to the confidence intervals and *p*-values.
