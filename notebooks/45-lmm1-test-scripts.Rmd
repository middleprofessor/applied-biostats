...
```{r fake_data}
all_treatments_per_batch <- function(sigma=1, sigma_b0=1, sigma_b1=1, beta_0=10, beta_1=1, n_batch=6, n_reps=10){
  ...
  for(i in 1:n_batch){
    ...
    y1 <- beta_0 + beta_0i + (beta_1 + beta_1i)*0 + rnorm(n_reps, mean=0, sd=sigma)
    y2 <- beta_0 + beta_0i + (beta_1 + beta_1i)*1 + rnorm(n_reps, mean=0, sd=sigma)
